...
urlpatterns = [
    ...
    path('pdf/sign/nss/<int:pk>/', views.sign_with_image_nss, name='sign_with_image_nss'),
    path('pdf/sign/supervisor/<int:pk>/', views.sign_with_image_supervisor, name='sign_with_image_supervisor'),
    path('pdf/sign/admin/<int:pk>/', views.sign_with_image_admin, name='sign_with_image_admin'),
