...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-default-dev-only-key')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='nssapi'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='NSS')